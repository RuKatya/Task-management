...
exports.logOut = exports.handleLogin = exports.handleReg = void 0;
...
exports.handleReg = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, repeat, name, condidate, errors, hashpassword, user, error_1, error_2;
...
exports.handleLogin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email_1, password, condidate, errors, areSame, error_3, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 8, , 9]);
